...
VALUES (UNHEX(REPLACE('4013c0f7-0c97-4bd7-a200-0de1392f1df0', '-', '')), 'testid', '$2a$12$./wHNApeq/feNKojcfkWouvZJfPrhdbDKWXQZWZy9PaW7pnkt/ZV6', 'ENTERPRISE', 'Test Enterprise', '123-45-6789', '987-65-4321', 'Test Address', 1, 'Manager Name', '010-1234-5678', 'manager@test.com', 'korea', NOW(), NOW())
ON DUPLICATE KEY UPDATE login_id = login_id;

-- users 테이블에 테스트 계정 삽입
/*
