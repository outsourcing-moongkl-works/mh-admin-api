...
VALUES (UNHEX(REPLACE('4012c0f7-0c97-4bd7-a200-0de1392f1df0', '-', '')), 'test@admin.com', '$2a$12$Zh3ZgM9YNNwgHNoQlEPTdejCea56f7VNDOltbM5INHRAf4RUe89m6', 'MASTER', NOW(), NOW())
ON DUPLICATE KEY UPDATE password = '$2a$12$Zh3ZgM9YNNwgHNoQlEPTdejCea56f7VNDOltbM5INHRAf4RUe89m6';
